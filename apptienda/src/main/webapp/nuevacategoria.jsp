...
<html>
    <head>
        ...
        <title>Ingresar Nuevo ninio</title>
    </head>
    <body>
        ...
        <section class="form">            
            <div class="cover-caption">
                <div class="title-form">                    
                    ...
                    <h3 class="h1-form">Ingresar una nueva categoria</h3>                    
                </div>                
                <hr class="hr-form">
                <form class="cover-caption__form" name="frmcat" action="srvnewcat" method="POST">            
                    ...
                    <div class="form-group">
                        <label class="form-group__label" for="subcat">Categoria anterior:</label>                                          
